<?php
    ...
    $mail->IsHTML(true);
    $mail->Subject="Password Reset from OES";
    $mail->Body="welcome back to Online Examination System. Your New Password is $pwd . Please change it into strong Password";
    if(!$mail->send())
    {
